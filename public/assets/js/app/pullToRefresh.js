(function (global, factory) {
    ...
    function update(handler) {
        ...
        if (textEl) {
            ...
            if (_shared.state === 'refreshing') {
                textEl.innerHTML =  is_night() ?  ' <img src="/assets/img/brand/loaderNight.gif" alt="">' : ' <img src="/assets/img/brand/loader.gif" alt="">';
            }
        }
    }
    ...
    var _setupEvents = (function () {
        ...
        function _onTouchStart(e) {
            ...
            if (target && _shared.state === 'pending' && screenY(e) < 350 && is_on_screen) {

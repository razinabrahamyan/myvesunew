                        ...
                        <form role="form" method="post" action="{{route('register')}}">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control {{ $errors->has('username') ? ' is-invalid' : '' }}" placeholder="Username *" value="{{ old('username') }}" type="text" name="username" required>
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="Password *" type="password" name="password" value="{{ old('password') }}" required>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-warning mt-4">Create account</button>
                            </div>
                        </form>
                    </div>
                </div>
